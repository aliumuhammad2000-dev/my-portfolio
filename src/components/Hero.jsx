    ...
    <section id="home" aria-labelledby="hero-heading" className="page-width scroll-mt-28 pb-10 pt-14 md:pt-24">
      <div className="grid items-center gap-14 lg:grid-cols-[1.35fr_1fr] lg:gap-20">
        <div>
          ...
          <h1 id="hero-heading" className="text-[clamp(3rem,7vw,6.5rem)] leading-[0.98] font-semibold tracking-[-0.065em]">Frontend<br /><span className="text-teal-300">Developer.</span></h1>
          <p className="mt-8 max-w-lg text-lg leading-8 text-slate-300">I turn ideas into thoughtful web experiences. Built with care, made to work beautifully on every screen.</p>
        ...
        <div className="relative mx-auto w-full max-w-sm lg:max-w-none">
          <div className="absolute inset-0 rotate-2 rounded-4xl border border-teal-300/25" aria-hidden="true" />
